...
function show_vertical_posts_3_columns ( $categoria_slug, $categoria_nome ){ ?>

    <div>
    <span class="titulo-secao c-ed-<?php echo $categoria_slug ?>" style="padding-bottom: 30px"><a href="https://emtempo1.com/<?php echo $categoria_slug ?>"><?php echo $categoria_nome ?></a></span>
    <?php 
    $custom_query = new WP_Query( array( 'posts_per_page' => -1, 'category_name' => $categoria_nome ) ); 
    $aux = 0;
    while($custom_query->have_posts()) : $custom_query->the_post(); 
        ...
        if ($aux == 1) { ?>
            <div class="tc-container">
                ...
                ?>
                <div class="tc-conteudo">
                    <a href="<?php the_permalink(); ?>"><?php the_title("<h2>", "</h2>") ?></a>
                </div>
            </div>
        <?php
        } else if ($aux > 1) {  ?>
            <div class="tc-container-secundario">
                <div>
                    <?php 
                    if ( has_post_thumbnail() ) { ?>
                        <a href="<?php the_permalink(); ?>">
